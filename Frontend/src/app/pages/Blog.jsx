...
function Blog() {
  ...
  >
    ...
    key={index}
    className={`px-5 py-2 rounded-full transition-colors ${index === 0 ? "bg-aw-green text-white" : "bg-aw-light-gray text-aw-dark-gray hover:bg-aw-mid-gray"}`}
  >
                {category}
              </button>)}
          </div>
    ...
    className="bg-white rounded-lg overflow-hidden hover:shadow-xl transition-shadow group cursor-default"
  >
