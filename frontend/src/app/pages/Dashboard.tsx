import { motion, useSpring, useTransform, animate as motionAnimate } from "motion/react";
import { Zap, Battery, Footprints, TrendingUp, Calendar, Activity } from "lucide-react";
import { LineChart, Line, AreaChart, Area, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from "recharts";
import { useEffect, useRef, useState } from "react";

// ─── Animated number ─────────────────────────────────────────────────────────
function LiveNumber({ value, suffix = "" }: { value: string; suffix?: string }) {
...
export function Dashboard() {
  const energyData = [
    { time: "6am", energy: 12 }, { time: "9am", energy: 45 }, { time: "12pm", energy: 78 },
    { time: "3pm", energy: 92 }, { time: "6pm", energy: 125 }, { time: "9pm", energy: 148 },
  ];
  const weeklySteps = [
    { day: "Mon", steps: 8432 }, { day: "Tue", steps: 9876 }, { day: "Wed", steps: 7234 },
    { day: "Thu", steps: 10542 }, { day: "Fri", steps: 8965 }, { day: "Sat", steps: 12345 }, { day: "Sun", steps: 6789 },
  ];
  const batteryHistory = [
    { hour: "1h", level: 45 }, { hour: "2h", level: 52 }, { hour: "3h", level: 61 },
    { hour: "4h", level: 73 }, { hour: "5h", level: 85 }, { hour: "6h", level: 92 },
  ];
  ...
  const recentActivity = [
    ...
    { time: "5 hours ago", activity: "Morning walk completed", energy: "32 Wh generated", icon: "👟" },
    { time: "1 day ago", activity: "Device synced successfully", energy: "Data updated", icon: "📡" },
  ];
