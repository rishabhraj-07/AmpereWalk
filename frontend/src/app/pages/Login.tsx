...
export function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-aw-light-gray py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {isLogin && (
                <div className="flex items-center justify-between text-sm">
                  ...
                  <a href="#" className="text-aw-green hover:text-aw-navy transition-colors">
                    Forgot password?
                  </a>
                </div>
              )}
