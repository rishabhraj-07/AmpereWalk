...
function Careers() {
  ...
  >
    ...
    className="bg-white p-6 rounded-lg hover:shadow-lg transition-all group cursor-default"
  >
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  ...
                  <button className="px-6 py-3 bg-aw-green text-white rounded-lg hover:bg-aw-lime transition-colors flex items-center gap-2 group-hover:gap-3 self-start lg:self-center whitespace-nowrap">
                    Apply Now
    ...
    /* CTA Section */
      ...
      <section className="py-20 bg-aw-green text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <button className="px-10 py-4 bg-white text-aw-green rounded-lg hover:bg-aw-light-gray transition-colors text-lg">
            Send Your Resume
          </button>
        </div>
      </section>
